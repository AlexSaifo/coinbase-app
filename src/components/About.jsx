            ...
            <div className="content flex column gap">
                ...
                <div className="flex gap">
                    <div className="info flex column gap a-start j-center">
                        ...
                        <p className="subdue">
                            We won’t ask you to link to your bank accounts,
                            we just want everyone to have the opportunity to understand
                            the potential of saving and investing for retirement or short term goals.
                            We simply do data analytics and simplify the way you look at investment assets
                        </p>
